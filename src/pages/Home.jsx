...
const Home = () => {
  ...
  const handleMenuClick = (action) => {
    ...
    switch (action) {
      ...
      case "upgrade":
        window.open(
          "https://neftyblocks.com/collection/nightclubnft/blends",
          "_blank",
        );
        break;
      case "history":
  ...
  return (
    <div className="home-main-wrapper">
        ...
        <div className="home-image-row">
          <div className="home-image-container fab-rounded">
            <div className="top-info-bar inside-map">
              <div className="top-info-item user-name">
                {UserService.getName()}
              </div>
              <div className="top-info-item user-level">Lvl 1</div>
              <div className="top-info-item wax-balance">
                {UserService.formatWAXOnly()} WAX
              </div>
            ...
            <div
              ...
              onClick={() => {
                setOnlyFapsGirl("Sandra");
                setShowOnlyFaps(true);
              }}
            />
            <div
      ...
      {showMissionStatus && (
        <MissionStatus onClose={() => setShowMissionStatus(false)} />
      )}
      {showOnlyFaps && (
        <OnlyFapsModal
          girlName={onlyFapsGirl}
          onClose={() => setShowOnlyFaps(false)}
        />
      )}
      {showInventory && (
      ...
      {showRotateWarning && (
        <div className="rotate-warning-bg-modern">
          ...
          <div className="rotate-sub-modern">
      ...
      <style jsx>{`
        ...
        .phone-rotate-anim {
          animation: phoneRotateAnim 2.8s infinite
