...
export default function Home({ userName, balance, handleLogout }) {
  return (
    <>
      <Helmet>
        <title>Night Club Game - Your Dashboard</title>
        <meta name="description" content={`Welcome back, ${userName}! Manage your missions, check your sexy NFT girls, and see your rewards.`} />
      </Helmet>
